  ...
  while (getline(levelfile, line, '\n'))
  {
    ...
    if (line != "")
    {
      ...
      else if (token == "bg")
      {
        ...
        tR = NEXT_TOK; tG = NEXT_TOK; tB = NEXT_TOK;
      ...
      {
        tX = NEXT_TOK; tY = NEXT_TOK; tX2 = NEXT_TOK; tY2 = NEXT_TOK; tC1 = NEXT_TOK;
      ...
      {
        tR = NEXT_TOK; tG = NEXT_TOK; tB = NEXT_TOK; tA = NEXT_TOK; tC1 = NEXT_TOK;
        if (tR == "" || tG == "" || tB == "" || tA == "" || tC1 == "")
      ...
      else if (token == "player")
      {
        ...
        tX = NEXT_TOK; tY = NEXT_TOK; tC1 = NEXT_TOK; tC2 = NEXT_TOK;
      ...
      {
        tR = NEXT_TOK; tG = NEXT_TOK; tB  = NEXT_TOK; tA  = NEXT_TOK;
        tC1 = NEXT_TOK; tC2 = NEXT_TOK; tC3 = NEXT_TOK; tC4 = NEXT_TOK;
        tC5 = NEXT_TOK; tC6 = NEXT_TOK; tC7 = NEXT_TOK; tC8 = NEXT_TOK;
        tC9 = NEXT_TOK;
        tX = NEXT_TOK; tY = NEXT_TOK; tX2 = NEXT_TOK; tY2 = NEXT_TOK;
      ...
      else if (token == "door")
      {
        ...
        tC1 = NEXT_TOK; tC2 = NEXT_TOK; tC3 = NEXT_TOK; tC4 = NEXT_TOK;
        tC5 = NEXT_TOK; tC6 = NEXT_TOK; tC7 = NEXT_TOK; tC8 = NEXT_TOK;
        tC9 = NEXT_TOK; tC10 = NEXT_TOK; tC11 = NEXT_TOK; tC12 = NEXT_TOK;
        tC13 = NEXT_TOK; tC14 = NEXT_TOK; tC15 = NEXT_TOK; tC16 = NEXT_TOK;
        tC17 = NEXT_TOK; tC18 = NEXT_TOK;
        tX = NEXT_TOK; tY = NEXT_TOK; tX2 = NEXT_TOK; tY2 = NEXT_TOK;
      ...
      else if (token == "floor" || token == "ceil" || token == "surf" || token == "mask")
      {
        ...
        if (token == "floor")
        {
          tC1 = NEXT_TOK; tC2 = NEXT_TOK; tC3 = NEXT_TOK; tC4 = NEXT_TOK; tC5 = NEXT_TOK;
          tX = NEXT_TOK; tY = NEXT_TOK; tX2 = NEXT_TOK; tY2 = NEXT_TOK;
      ...
      {
        tX = NEXT_TOK; tY = NEXT_TOK;
        addNode(S2F(tX), S2F(tY));
      }
      else if (token == "obj")
      {
        tC1 = NEXT_TOK; tC2 = NEXT_TOK; tC3 = NEXT_TOK; tC4 = NEXT_TOK; tC5 = NEXT_TOK; tC6 = NEXT_TOK; tC7 = NEXT_TOK; tC8 = NEXT_TOK;
        tX = NEXT_TOK; tY = NEXT_TOK;
      ...
      {
        tR = NEXT_TOK; tG = NEXT_TOK; tB = NEXT_TOK; tA = NEXT_TOK;
        tC1 = NEXT_TOK; tX = NEXT_TOK; tY = NEXT_TOK; tC2 = NEXT_TOK;
...
void Level::start()
{
  ...
  for (int i = 0; i < door.size(); i++)
  { door[i].resetTrigger(); door[i].reset(); }
